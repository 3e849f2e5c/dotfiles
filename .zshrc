...
export ZSH="/home/aneko/.oh-my-zsh"
...
tmux list-sessions | grep -v attached | cut -d: -f1 |  xargs -t -n1 tmux kill-session -t 2> /dev/null

source /home/aneko/git/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
